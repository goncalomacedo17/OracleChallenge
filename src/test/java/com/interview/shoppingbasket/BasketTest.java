...
public class BasketTest {
    ...
    void consolidateBasketTest() {
        ...
        Basket basket = new Basket();
        basket.add("cod123","psp",6);
        basket.add("cod124","ps4",12);
        basket.add("cod123","psp",9);   //irá somar 6 + 9 pois tem o mesmo productCode
        ...
        assertEquals(basketSize.get(0).getProductCode(),"cod123");
        assertEquals(basketSize.get(0).getProductName(),"psp");
